...
4. **Classification & enrichment**: predictions populate columns such as `Categoria`, `Previṣo`, `Possibilidade`, `A̤̣o`, `Justificativa`, confidence, and priority score, plus any backend-specific explanations.
